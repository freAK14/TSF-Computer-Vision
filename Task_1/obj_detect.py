...
def main(type, iou_threshold, confidence_threshold, input_names):
    ...
    if type == 'images':
        ...
        with tf.compat.v1.Session() as sess:
            ...
            out = cv2.VideoWriter("./detections/detections.mp4", fourcc, fps, (int(frame_size[0]), int(frame_size[1])))
        ...
        raise ValueError("Inappropiate data type. please choose either 'video' or 'images'.")
